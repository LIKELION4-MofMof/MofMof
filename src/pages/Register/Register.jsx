...
import { useSignUp } from 'firebase-db/auth-db/index';
        ...
        <RegisterForm onSubmit={handleSubmit} onReset={handleReset}>
          ...
          <fieldset>
            ...
            <RegisterInput
              ...
              onChange={handleChangeInput}
              required
              placeholder="이름(실명) 입력해주세요."
            />
            {nameErrorMessage && (
              <ErrorMessage>이름은 두 글자 이상 입력해주세요.</ErrorMessage>
            )}
          ...
          <Agreement>
            <div>
              ...
              />
              <RegisterLabel htmlFor="agreementAll">
                약관 전체 동의하기(선택 동의 포함)
              </RegisterLabel>
            </div>
            <div>
            ...
            <div>
              ...
              />
              <label htmlFor="agreementPrivacy">
                [필수] 개인정보 수집 및 이용 동의
              </label>
              <AgreementDetail>자세히</AgreementDetail>
            </div>
            <div>
              <AgreementInput
                type="checkbox"
                id="agreementAdvertisement"
                checked={advertisementCheck}
                onChange={advertiseBtnEvent}
              />
              <label htmlFor="agreementAdvertisement">
                [선택] 광고성 정보 수신 동의
              </label>
            </div>
            <SubmitBtn
              type="submit"
              disabled={isEmail && isName && isPasswordConfirm}
            >
              본인인증하고 가입하기
            </SubmitBtn>
          </Agreement>
